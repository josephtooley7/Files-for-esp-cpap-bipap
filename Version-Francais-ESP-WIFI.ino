...
<body style="background-color: rgb(100, 100, 100); margin: 0;">
  ...
  <div style="width: 100%; text-align: center; padding-top: 40px;">
    <a href="/lost.html">
      <button style="background-color: rgb(2, 113, 249); color: #f6f5f5; font-size: 1cm; border-radius: 10px; padding: 20px 100px;">Localiser</button>
    </a>
  </div>

  <div style="width: 100%; text-align: center; padding-top: 40px;">
    <a href="/save.html">
      <button style="background-color: rgb(2, 113, 249); color: #f6f5f5; font-size: 1cm; border-radius: 10px; padding: 20px 92px;">Sauvegarder</button>
    </a>
  </div>
...
<html>
<head>
  <title>Temps de Respiration</title>
  <style>
    body {
...
<body>
  ...
  <div class="section">
    ...
    <div>
      <button onclick="sendInspTime()" class="button">Sauvegarder Inspiration</button>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div>
      <button onclick="sendExpTime()" class="button">Sauvegarder Expiration</button>
    </div>
  </div>
  ...
  <script>
    ...
    function sendInspTime() {
      ...
      .then(r => r.text())
      .then(data => alert("Temps d'Inspiration Envoyer: " + val))
      .catch(err => alert("Erreur d'Envoyer."));
    }
    ...
    function sendExpTime() {
      ...
      .then(r => r.text())
      .then(data => alert("Temps d'Expiration Envoyer: " + val))
      .catch(err => alert("Erreur d'Envoyer."));
    }
  </script>
  ...
  <div style="padding-top:40px;">
    <a href="/controls.html">
      <button class="button" style="padding:20px 100px;">Retour</button>
    </a>
  </div>

  <div style="padding-top:40px;">
    <a href="/">
      <button class="button" style="padding:20px 100px;">Menu</button>
    </a>
  </div>
...
// LED Page to be used for a speaker
...
<body style="background-color: rgb(100, 100, 100); margin: 0;">
  ...
  <div style="text-align:center;">
    ...
    <a href="/"><button style="padding: 10px 20px;">Retour</button></a>
  </div>
</body>
</html>
)=====";
...
<body style="background-color: rgb(100, 100, 100); margin: 0;">
  ...
  <div style="width: 100%; text-align: center; padding-top: 40px;">
        <a href="/humidity.html">
           <button style="background-color: rgb(2, 113, 249); color: #f6f5f5; font-size: 1cm; border-radius: 10px; padding: 20px 65px;">Humidité</button>
  ...
  <div style="width: 100%; text-align: center; padding-top: 40px;">
        <a href="/pressure.html">
           <button style="background-color: rgb(2, 113, 249); color: #f6f5f5; font-size: 1cm; border-radius: 10px; padding: 20px 65px;">Pression</button>
...
<body style="background-color: rgb(100, 100, 100); margin: 0; text-align:center;">
  ...
  <script>
    function sendMode() {
      ...
      .then(r => r.text())
      .then(data => alert("Mode Envoyer: " + mode))
      .catch(err => alert("Erreur d'Envoyer la Mode."));
    }
  </script>

  <div style="padding-top:40px;">
    <a href="/controls.html">
      <button style="background-color:rgb(2,113,249);color:#f6f5f5;font-size:1cm;border-radius:10px;padding:20px 100px;">Retour</button>
    </a>
  </div>
  <div style="padding-top:40px;">
    <a href="/">
      <button style="background-color:rgb(2,113,249);color:#f6f5f5;font-size:1cm;border-radius:10px;padding:20px 100px;">Menu</button>
    </a>
  </div>
</body>
</html>
...
<!-- Page Title -->
  ...
  <script>
    ...
    function sendMinPressure() {
      ...
      if (val === null) {
        alert("Veuillez saisir une pression minimale comprise entre 3 and 40.");
        return;
      }
      ...
      .then(r => r.text())
      .then(data => alert("Pression MIN Envoyer: " + val))
      .catch(err => alert("Erreur d'Envoyer la Pression MIN."));
    }
    ...
    function sendMaxPressure() {
      ...
      .then(r => r.text())
      .then(data => alert("Pression MAX Envoyer: " + val))
      .catch(err => alert("Erreur d'Envoyer la pression MAX."));
    }
  </script>
  ...
  <script>
    function sendCpapPressure() {
      ...
      if (val === null) {
        alert("Veuillez saisir une pression CPAP comprise entre 3 and 40.");
        return;
      }
      ...
      .then(r => r.text())
      .then(data => alert("Pression CPAP Envouer: " + val))
      .catch(err => alert("Erreur d'Envoyer la Prassion CPAP."));
    }
  </script>
...
<html>
<head>
  <title>Réglages d'Humidité </title>
  <style>
    .custom-input {
      font-size: 1.2cm;
      color: rgb(9, 25, 139);
...
<body style="background-color: rgb(100, 100, 100); margin: 0; width: 100%; text-align: center; padding-top: 50px;">
  ...
  function sendHumidity() {
    ...
    if (isNaN(humidity) || humidity < 0 || humidity > 95) {
      alert("Veuillez saisir une valeur d'humidité comprise entre 0 and 95.");
      return;
    }
    ...
    .then(data => {
      console.log(data);
      alert("Humidité Envoyer: " + humidity);
    })
    .catch(error => {
      console.error("Error:", error);
      alert("Erreur d'envoiyer des données d'humidité.");
    });
  }
  </script>
